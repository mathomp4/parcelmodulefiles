...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=/Users/mathomp4/installed/MPI/gcc-gfortran-9.1.0/openmpi-4.0.1-MPI1/Baselibs/5.1.6/Darwin |& tee makeinstall.gcc-gfortran-9.1.0_openmpi-4.0.1-MPI1.log
--
-- ]]
