...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=/Users/mathomp4/installed/MPI/gcc-gfortran-9.1.0/openmpi-4.0.1-MPI1/Baselibs/5.1.7-nousrinclude/Darwin |& tee makeinstall.gcc-gfortran-9.1.0_openmpi-4.0.1-MPI1.log
--
-- ]]

family("Baselibs")
--prereq("gcc-gfortran/9.1.0", "openmpi/4.0.1-MPI1")

local compilername = "gcc-gfortran-9.1.0"
local mpiname = "openmpi-4.0.1-MPI1"

local version = "5.1.7-nousrinclude"
