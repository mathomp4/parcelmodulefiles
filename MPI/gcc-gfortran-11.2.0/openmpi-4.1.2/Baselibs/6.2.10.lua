...
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-11.2.0/openmpi-4.1.2/Baselibs/6.2.10/Darwin |& tee makeinstall.gcc-gfortran-11.2.0_openmpi-4.1.2.log
--
