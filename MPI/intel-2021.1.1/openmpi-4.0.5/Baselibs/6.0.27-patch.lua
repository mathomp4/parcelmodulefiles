...
--
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=intel prefix=$HOME/installed/MPI/intel-2021.1.1/openmpi-4.0.5/Baselibs/6.0.27-patch/Darwin |& tee makeinstall.intel-2021.1.1_openmpi-4.0.5.log
--
