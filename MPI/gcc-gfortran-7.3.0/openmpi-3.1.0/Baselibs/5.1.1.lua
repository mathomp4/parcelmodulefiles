...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=/Users/mathomp4/installed/MPI/gcc-gfortran-7.3.0/openmpi-3.1.0/Baselibs/5.1.1/Darwin |& tee makeinstall.gcc-gfortran-7.3.0_openmpi-3.1.0.log
--
-- ]]

family("Baselibs")
--prereq("gcc-gfortran/7.3.0", "openmpi/3.1.0")

local compilername = "gcc-gfortran-7.3.0"
local mpiname = "openmpi-3.1.0"
