...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=/Users/mathomp4/installed/MPI/gcc-gfortran-7.3.0/openmpi-3.0.0/Baselibs/5.1.0/Darwin |& tee makeinstall.gcc-gfortran-7.3.0_openmpi-3.0.0.log
--
-- ]]
