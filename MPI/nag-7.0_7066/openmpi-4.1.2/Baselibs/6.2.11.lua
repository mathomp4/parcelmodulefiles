...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=nag prefix=$HOME/installed/MPI/nag-7.0_7066/openmpi-4.1.2/Baselibs/6.2.11/Darwin |& tee makeinstall.nag-7.0_7066_openmpi-4.1.2.log
--
...
family("Baselibs")
--prereq("nag/7.0_7066", "openmpi/4.1.2")
