...
-- $ make -j4 install ESMF_COMM=mpiuni ESMF_COMPILER=nag prefix=$HOME/installed/MPI/nag-7.0_7062/mpiuni/Baselibs/6.2.8/Darwin |& tee makeinstall.nag-7.0_7062_mpiuni.log
--
