...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortranclang prefix=/Users/mathomp4/installed/MPI/clang-gfortran-6.3.0/openmpi-3.0.0/Baselibs/5.0.11/Darwin |& tee makeinstall.clang-gfortran-6.3.0_openmpi-3.0.0.log
--
-- ]]
