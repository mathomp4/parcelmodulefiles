...
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-11.1.0/openmpi-4.1.1/Baselibs/6.1.0/Darwin |& tee makeinstall.gcc-gfortran-11.1.0_openmpi-4.1.1.log
--
