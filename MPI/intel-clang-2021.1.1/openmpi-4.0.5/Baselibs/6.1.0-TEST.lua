...
--
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=intelclang prefix=$HOME/installed/MPI/intel-clang-2021.1.1/openmpi-4.0.5/Baselibs/6.1.0-TEST/Darwin |& tee makeinstall.intel-clang-2021.1.1_openmpi-4.0.5.log
--
...
family("Baselibs")
-- prereq("GMAOpyD", "intel-clang/2021.1.1", "openmpi/4.0.5")
