...
--
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=intelclang prefix=$HOME/installed/MPI/intel-clang-2021.1.1/openmpi-4.1.0/Baselibs/6.1.0-TEST/Darwin |& tee makeinstall.intel-clang-2021.1.1_openmpi-4.1.0.log
--
...
family("Baselibs")
-- prereq("GMAOpyD", "intel-clang/2021.1.1", "openmpi/4.1.0")

local compilername = "intel-clang-2021.1.1"
local mpiname = "openmpi-4.1.0"

local version = "6.1.0-TEST"
