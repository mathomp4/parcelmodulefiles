...
--
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=intelclang prefix=$HOME/installed/MPI/intel-clang-2020.4.301/openmpi-4.1.0/Baselibs/6.0.27/Darwin |& tee makeinstall.intel-clang-2020.4.301_openmpi-4.1.0.log
--
...
family("Baselibs")
-- prereq("GMAOpyD", "intel-clang/2020.4.301", "openmpi/4.1.0")
