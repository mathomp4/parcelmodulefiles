...
--
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=intelclang prefix=$HOME/installed/MPI/intel-clang-2020.4.301/openmpi-4.0.5/Baselibs/6.0.26/Darwin |& tee makeinstall.intel-clang-2020.4.301_openmpi-4.0.5.log
--
