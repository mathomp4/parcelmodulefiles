...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=nag prefix=$HOME/installed/MPI/nag-7.1_7113/openmpi-4.1.4/Baselibs/7.6.0/Darwin |& tee makeinstall.nag-7.1_7113_openmpi-4.1.4.log
--
...
family("Baselibs")
--prereq("nag/7.1_7113", "openmpi/4.1.4")
