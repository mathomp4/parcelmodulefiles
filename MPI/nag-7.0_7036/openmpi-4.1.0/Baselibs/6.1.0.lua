...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=nag prefix=$HOME/installed/MPI/nag-7.0_7036/openmpi-4.1.0/Baselibs/6.1.0/Darwin |& tee makeinstall.nag-7.0_7036_openmpi-4.1.0.log
--
