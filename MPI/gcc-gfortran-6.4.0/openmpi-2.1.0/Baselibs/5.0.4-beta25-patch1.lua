...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=/Users/mathomp4/installed/MPI/gcc-gfortran-6.4.0/openmpi-2.1.0/Baselibs/5.0.4-beta25-patch1/Darwin |& tee makeinstall.gcc-gfortran-6.4.0_openmpi-2.1.0.log
--
-- ]]

family("Baselibs")
--prereq("gcc-gfortran/6.4.0", "openmpi/2.1.0")

local compilername = "gcc-gfortran-6.4.0"
local mpiname = "openmpi-2.1.0"

local version = "5.0.4-beta25-patch1"
