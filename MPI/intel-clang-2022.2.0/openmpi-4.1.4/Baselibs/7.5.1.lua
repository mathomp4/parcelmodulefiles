...
--
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=intelclang prefix=$HOME/installed/MPI/intel-clang-2022.2.0/openmpi-4.1.4/Baselibs/7.5.1/Darwin |& tee makeinstall.intel-clang-2022.2.0_openmpi-4.1.4.log
--
