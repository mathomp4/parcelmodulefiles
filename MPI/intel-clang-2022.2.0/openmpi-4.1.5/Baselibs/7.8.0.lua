...
--
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=intelclang prefix=$HOME/installed/MPI/intel-clang-2022.2.0/openmpi-4.1.5/Baselibs/7.8.0/Darwin |& tee makeinstall.intel-clang-2022.2.0_openmpi-4.1.5.log
--
