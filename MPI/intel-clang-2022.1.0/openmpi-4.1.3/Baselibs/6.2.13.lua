...
--
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=intelclang prefix=$HOME/installed/MPI/intel-clang-2022.1.0/openmpi-4.1.3/Baselibs/6.2.13/Darwin |& tee makeinstall.intel-clang-2022.1.0_openmpi-4.1.3.log
--
...
family("Baselibs")
-- prereq("GMAOpyD", "intel-clang/2022.1.0", "openmpi/4.1.3")

local compilername = "intel-clang-2022.1.0"
