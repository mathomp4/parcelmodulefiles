...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=nag prefix=$HOME/installed/MPI/nag-7.0_7020/openmpi-4.0.5/Baselibs/6.0.17/Darwin |& tee makeinstall.nag-7.0_7020_openmpi-4.0.5.log
--
