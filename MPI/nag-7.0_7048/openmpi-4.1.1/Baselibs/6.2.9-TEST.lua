...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=nag prefix=$HOME/installed/MPI/nag-7.0_7048/openmpi-4.1.1/Baselibs/6.2.9-TEST/Darwin |& tee makeinstall.nag-7.0_7048_openmpi-4.1.1.log
--
...
family("Baselibs")
--prereq("nag/7.0_7048", "openmpi/4.1.1")
