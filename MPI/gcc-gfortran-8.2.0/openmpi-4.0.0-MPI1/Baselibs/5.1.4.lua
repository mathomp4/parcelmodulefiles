...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=/Users/mathomp4/installed/MPI/gcc-gfortran-8.2.0/openmpi-4.0.0-MPI1/Baselibs/5.1.4/Darwin |& tee makeinstall.gcc-gfortran-8.2.0_openmpi-4.0.0-MPI1.log
--
-- ]]

family("Baselibs")
--prereq("gcc-gfortran/8.2.0", "openmpi/4.0.0-MPI1")
