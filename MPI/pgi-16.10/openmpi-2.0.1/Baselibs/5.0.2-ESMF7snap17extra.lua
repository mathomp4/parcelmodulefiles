...
-- $ make install ESMF_COMM=openmpi ESMF_COMPILER=pgi prefix=/Users/mathomp4/installed/MPI/pgi-16.10/openmpi-2.0.1/Baselibs/5.0.2-ESMF7snap17extra/Darwin
--
-- ]]

family("Baselibs")
--prereq("pgi/16.10", "openmpi-2.0.1")
