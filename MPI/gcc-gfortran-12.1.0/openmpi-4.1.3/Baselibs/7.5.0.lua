...
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-12.1.0/openmpi-4.1.3/Baselibs/7.5.0/Darwin |& tee makeinstall.gcc-gfortran-12.1.0_openmpi-4.1.3.log
--
