...
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-10.3.0/openmpi-4.1.0/Baselibs/6.2.7/Darwin |& tee makeinstall.gcc-gfortran-10.3.0_openmpi-4.1.0.log
--
