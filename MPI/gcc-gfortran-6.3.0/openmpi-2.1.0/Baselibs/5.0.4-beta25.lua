...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=/Users/mathomp4/installed/MPI/gcc-gfortran-6.3.0/openmpi-2.1.0/Baselibs/5.0.4-beta25/Darwin |& tee makeinstall.gcc-gfortran-6.3.0_openmpi-2.1.0.log
--
-- ]]
