...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-10.2.0/openmpi-4.0.5/Baselibs/6.0.22/Darwin |& tee makeinstall.gcc-gfortran-10.2.0_openmpi-4.0.5.log
--
