...
-- $ make -j3 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-10.2.0/openmpi-4.0.4/Baselibs/6.0.16/Darwin |& tee makeinstall.gcc-gfortran-10.2.0_openmpi-4.0.4.log
--
-- ]]
