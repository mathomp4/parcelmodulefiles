...
--
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=intelclang prefix=$HOME/installed/MPI/intel-clang-2021.2.0/openmpi-4.1.1/Baselibs/6.2.9-TEST/Darwin |& tee makeinstall.intel-clang-2021.2.0_openmpi-4.1.1.log
--
...
family("Baselibs")
-- prereq("GMAOpyD", "intel-clang/2021.2.0", "openmpi/4.1.1")

local compilername = "intel-clang-2021.2.0"
local mpiname = "openmpi-4.1.1"

local version = "6.2.9-TEST"
