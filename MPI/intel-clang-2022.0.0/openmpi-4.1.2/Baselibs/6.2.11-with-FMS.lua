...
--
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=intelclang prefix=$HOME/installed/MPI/intel-clang-2022.0.0/openmpi-4.1.2/Baselibs/6.2.11-with-FMS/Darwin |& tee makeinstall.intel-clang-2022.0.0_openmpi-4.1.2.log
--
...
family("Baselibs")
-- prereq("GMAOpyD", "intel-clang/2022.0.0", "openmpi/4.1.2")

local compilername = "intel-clang-2022.0.0"
local mpiname = "openmpi-4.1.2"

local version = "6.2.11-with-FMS"
