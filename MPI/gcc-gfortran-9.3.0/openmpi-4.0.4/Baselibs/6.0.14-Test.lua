...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-9.3.0/openmpi-4.0.4/Baselibs/6.0.14-Test/Darwin |& tee makeinstall.gcc-gfortran-9.3.0_openmpi-4.0.4.log
--
-- ]]

family("Baselibs")
--prereq("gcc-gfortran/9.3.0", "openmpi/4.0.4")
