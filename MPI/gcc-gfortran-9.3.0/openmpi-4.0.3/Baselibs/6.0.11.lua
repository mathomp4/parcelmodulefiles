...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-9.3.0/openmpi-4.0.3/Baselibs/6.0.11/Darwin |& tee makeinstall.gcc-gfortran-9.3.0_openmpi-4.0.3.log
--
-- ]]
