...
-- $ make install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=/Users/mathomp4/installed/MPI/gcc-gfortran-6.2.0/openmpi-2.0.1/Baselibs/5.0.2/Darwin
--
-- ]]

family("Baselibs")
--prereq("gcc-gfortran/6.2.0", "openmpi/2.0.1")
