...
-- $ make -j6 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-12.2.0/openmpi-4.1.4/Baselibs/7.6.0/Darwin |& tee makeinstall.gcc-gfortran-12.2.0_openmpi-4.1.4.log
--
