...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-9.2.0/openmpi-4.0.3/Baselibs/6.0.8/Darwin |& tee makeinstall.gcc-gfortran-9.2.0_openmpi-4.0.3.log
--
-- ]]

family("Baselibs")
--prereq("gcc-gfortran/9.2.0", "openmpi/4.0.3")
