...
-- $ make -j4 install ESMF_COMM=openmpi ESMF_COMPILER=gfortran prefix=$HOME/installed/MPI/gcc-gfortran-9.2.0/openmpi-4.0.3/Baselibs/6.0.7/Darwin |& tee makeinstall.gcc-gfortran-9.2.0_openmpi-4.0.3.log
--
-- ]]
