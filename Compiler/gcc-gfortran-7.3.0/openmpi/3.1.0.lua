...
-- $ ./configure --disable-wrapper-rpath --disable-wrapper-runpath CC=gcc CXX=g++ FC=gfortran --without-verbs --prefix=$HOME/installed/Compiler/gcc-gfortran-7.3.0/openmpi/3.1.0 | & tee configure.gcc-gfortran-7.3.0.log
