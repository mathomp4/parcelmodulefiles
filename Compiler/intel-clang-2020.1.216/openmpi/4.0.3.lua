...
-- $ lt_cv_ld_force_load=no ./configure --disable-wrapper-rpath --disable-wrapper-runpath CC=clang CXX=clang++ FC=ifort --prefix=$HOME/installed/Compiler/intel-clang-2020.1.216/openmpi/4.0.3 |& tee configure.intel-clang-2020.1.216.log
-- $ mv config.log config.intel-clang-2020.1.216.log
-- $ make -j4 |& tee make.intel-clang-2020.1.216.log
-- $ make install |& tee makeinstall.intel-clang-2020.1.216.log
-- $ make check |& tee makecheck.intel-clang-2020.1.216.log
--
