...
-- $ ./configure --disable-wrapper-rpath CC=pgcc CXX=pgc++ FC=pgfortran FCFLAGS='-Mpreprocess -Mbackslash' --prefix=/Users/mathomp4/installed/Compiler/pgi-16.10/openmpi/2.0.1 | & tee configure.pgi-16.10.log
--
-- NOTE NOTE NOTE
