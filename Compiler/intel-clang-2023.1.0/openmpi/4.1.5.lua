...
--
-- $ mkdir build-intel-clang-2023.1.0 && cd build-intel-clang-2023.1.0
-- $ lt_cv_ld_force_load=no ../configure --disable-wrapper-rpath --disable-wrapper-runpath CC=clang CXX=clang++ FC=ifort --prefix=$HOME/installed/Compiler/intel-clang-2023.1.0/openmpi/4.1.5 |& tee configure.intel-clang-2023.1.0.log
-- $ mv config.log config.intel-clang-2023.1.0.log
-- $ make -j6 |& tee make.intel-clang-2023.1.0.log
-- $ make install |& tee makeinstall.intel-clang-2023.1.0.log
-- $ make check |& tee makecheck.intel-clang-2023.1.0.log
--
