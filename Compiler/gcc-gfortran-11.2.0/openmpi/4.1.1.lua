...
-- $ ./configure --disable-wrapper-rpath --disable-wrapper-runpath CC=gcc CXX=g++ FC=gfortran --prefix=$HOME/installed/Compiler/gcc-gfortran-11.2.0/openmpi/4.1.1 |& tee configure.gcc-gfortran-11.2.0.log
