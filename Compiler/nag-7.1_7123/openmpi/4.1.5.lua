...
--
-- $ mkdir build-nag-7.1_7123 && cd build-nag-7.1_7123
-- $ ../configure --disable-wrapper-rpath --disable-wrapper-runpath \
--     --prefix=$HOME/installed/Compiler/nag-7.1_7123/openmpi/4.1.5 |& tee configure.nag-7.1_7123.log
--
-- $ mv config.log config.nag-7.1_7123.log
-- $ make -j4 |& tee make.nag-7.1_7123.log
-- $ make install |& tee makeinstall.nag-7.1_7123.log
-- $ make check |& tee makecheck.nag-7.1_7123.log
--
-- ]]
...
local compilername = "nag-7.1_7123"
...
local mdir = pathJoin(mroot,"MPI/nag-7.1_7123",("openmpi-"..version))
