...
-- $ ./configure --disable-wrapper-rpath CC=gcc CXX=g++ FC=gfortran --without-verbs --prefix=/Users/mathomp4/installed/Compiler/gcc-gfortran-6.3.0/openmpi/2.1.0 | & tee configure.gcc-gfortran-6.3.0.log
--
-- ]]
