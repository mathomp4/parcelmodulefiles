...
--
-- $ mkdir build-nag-7.1_7113 && cd build-nag-7.1_7113
-- $ ../configure --disable-wrapper-rpath --disable-wrapper-runpath \
--     --prefix=$HOME/installed/Compiler/nag-7.1_7113/openmpi/4.1.4 |& tee configure.nag-7.1_7113.log
--
-- $ mv config.log config.nag-7.1_7113.log
-- $ make -j4 |& tee make.nag-7.1_7113.log
-- $ make install |& tee makeinstall.nag-7.1_7113.log
-- $ make check |& tee makecheck.nag-7.1_7113.log
--
-- ]]
...
local compilername = "nag-7.1_7113"
...
local mdir = pathJoin(mroot,"MPI/nag-7.1_7113",("openmpi-"..version))
