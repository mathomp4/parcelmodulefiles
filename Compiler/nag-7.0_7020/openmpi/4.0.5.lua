...
-- $ ./configure --disable-wrapper-rpath --disable-wrapper-runpath FCFLAGS"=-mismatch_all -fpp" CC=gcc CXX=g++ FC=nagfor --prefix=$HOME/installed/Compiler/nag-7.0_7020/openmpi/4.0.5 |& tee configure.nag-7.0_7020.log
