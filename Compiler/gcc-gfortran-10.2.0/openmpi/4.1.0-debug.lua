...
-- $ ./configure --disable-wrapper-rpath --disable-wrapper-runpath CC=gcc CXX=g++ FC=gfortran --enable-debug --prefix=$HOME/installed/Compiler/gcc-gfortran-10.2.0/openmpi/4.1.0-debug |& tee configure.gcc-gfortran-10.2.0.log
