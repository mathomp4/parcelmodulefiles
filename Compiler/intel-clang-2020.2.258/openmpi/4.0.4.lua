...
-- $ lt_cv_ld_force_load=no ./configure --disable-wrapper-rpath --disable-wrapper-runpath CC=clang CXX=clang++ FC=ifort --prefix=$HOME/installed/Compiler/intel-clang-2020.2.258/openmpi/4.0.4 |& tee configure.intel-clang-2020.2.258.log
-- $ mv config.log config.intel-clang-2020.2.258.log
-- $ make -j4 |& tee make.intel-clang-2020.2.258.log
-- $ make install |& tee makeinstall.intel-clang-2020.2.258.log
-- $ make check |& tee makecheck.intel-clang-2020.2.258.log
--
...
family("MPI")
local intel_version = "2020.2.258"
