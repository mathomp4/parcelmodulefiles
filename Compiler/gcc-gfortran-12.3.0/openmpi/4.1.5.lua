...
-- $ ../configure --disable-wrapper-rpath --disable-wrapper-runpath CC=gcc CXX=g++ FC=gfortran --prefix=$HOME/installed/Compiler/gcc-gfortran-12.3.0/openmpi/4.1.5 |& tee configure.gcc-gfortran-12.3.0.log
-- $ mv config.log config.gcc-gfortran-12.3.0.log
-- $ make -j4 |& tee make.gcc-gfortran-12.3.0.log
