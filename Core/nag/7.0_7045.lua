...
-- You must run:
--
-- install_name_tool -id $HOME/installed/Core/nag/7.0_7045/lib/NAG_Fortran/libf70rts.dylib $HOME/installed/Core/nag/7.0_7045/lib/NAG_Fortran/libf70rts.dylib
--
...
-- ALSO ALSO ALSO
--
-- I had to run on the command line:
-- 
--  $HOME/installed/Core/nag/7.0_7045/lib/NAG_Fortran/nagfor
--
