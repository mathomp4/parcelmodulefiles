...
---- You must run:
----
---- install_name_tool -id $HOME/installed/Core/nag/7.1_7119/lib/NAG_Fortran/libf71rts.dylib $HOME/installed/Core/nag/7.1_7119/lib/NAG_Fortran/libf71rts.dylib
----
...
---- 
----  $HOME/installed/Core/nag/7.1_7119/lib/NAG_Fortran/nagfor
----
...
---- 
----   $HOME/installed/Core/nag/7.1_7119/bin/nagfor
----
---- And it worked!
--
