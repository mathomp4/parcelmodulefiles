...
---- You must run:
----
---- install_name_tool -id $HOME/installed/Core/nag/7.0_7066/lib/NAG_Fortran/libf70rts.dylib $HOME/installed/Core/nag/7.0_7066/lib/NAG_Fortran/libf70rts.dylib
----
