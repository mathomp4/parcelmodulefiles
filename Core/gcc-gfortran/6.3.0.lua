-- stub routine for gcc-gfortran 6.3.0 --
-- built with:
-- ../gcc-6.3.0/configure --prefix=/Users/mathomp4/installed/Core/gcc-gfortran/6.3.0 --enable-languages=c,c++,fortran --disable-multilib | & tee configure.log
--
...
local mdir  = pathJoin(mroot,"Compiler/gcc-gfortran-6.3.0")
