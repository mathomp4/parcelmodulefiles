-- stub routine for gcc-gfortran 12.2.0 --
-- built with:
--
...
--
--   mkdir BUILD-gcc-12.2.0 && cd BUILD-gcc-12.2.0
--   ../gcc-12.2.0/configure --prefix=$HOME/installed/Core/gcc-gfortran/12.2.0 --enable-languages=c,c++,fortran --with-sysroot=/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk |& tee configure.log
--
