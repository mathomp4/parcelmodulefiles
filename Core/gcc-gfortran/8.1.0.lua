-- stub routine for gcc-gfortran 8.1.0 --
-- built with:
...
--
-- ../gcc-8.1.0/configure --prefix=/Users/mathomp4/installed/Core/gcc-gfortran/8.1.0 --enable-languages=c,c++,fortran --disable-multilib | & tee configure.log
--
...
local mdir  = pathJoin(mroot,"Compiler/gcc-gfortran-8.1.0")
